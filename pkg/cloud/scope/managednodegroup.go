...
func NewManagedMachinePoolScope(params ManagedMachinePoolScopeParams) (*ManagedMachinePoolScope, error) {
	...
	return &ManagedMachinePoolScope{
		...
		allowUpdateLaunchTemplates: params.AllowUpdateLaunchTemplates,
		allowRecreateNodeGroups:    params.AllowRecreateNodeGroups,
		LaunchTemplateScope:        LaunchTemplateScope,
	}, nil
}
...
func (s *ManagedMachinePoolScope) IsNotPaused() bool {
	return !s.Cluster.Spec.Paused
}
...
// AllowUpdateLaunchTemplates indicates if launch template update is allowed.
func (s *ManagedMachinePoolScope) AllowUpdateLaunchTemplates() bool {
	return s.allowUpdateLaunchTemplates
}

// AllowRecreateNodeGroups indicates if node group recreation is allowed.
func (s *ManagedMachinePoolScope) AllowRecreateNodeGroups() bool {
	return s.allowRecreateNodeGroups
}

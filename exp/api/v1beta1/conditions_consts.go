...
const (
	...
	// EKSNodegroupInstanceProfilesPerAccountExceededReason used to report failures when node group has exceeded instance profile per account quota.
	EKSNodegroupInstanceProfilesPerAccountExceededReason = "EKSNodegroupInstanceProfilesPerAccountExceeded"
